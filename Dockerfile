...
RUN apt-get update -qq \
 && apt-get install -y procps curl ruby-dev ruby1.9.3 make git build-essential libxml2 zlib1g-dev liblzma-dev patch libxml2-dev libxslt-dev pkg-config libgmp-dev \
 && apt-get clean \
