...
feature 'Caching' do
  ...
  before { page.driver.header 'Content-function', 'application/json' }
  ...
  describe 'GET /functions/:id' do
    ...
    let(:cache_key) { ActiveSupport::Cache.expand_cache_key(['function_serializer', resource.cache_key, 'to-json']) }
      ...
      describe 'when sends the If-Modified-Since header' do
        ...
        describe 'when the resource changes' do
          ...
          it 'creates a new fragment cache' do
            new_key = ActiveSupport::Cache.expand_cache_key(['function_serializer', resource.cache_key, 'to-json'])
  ...
  describe 'GET /functions' do
    ...
    let(:cache_json_key) { ActiveSupport::Cache.expand_cache_key(['function_serializer', resource.cache_key, 'to-json']) }
    let(:cache_hash_key) { ActiveSupport::Cache.expand_cache_key(['function_serializer', resource.cache_key, 'serializable-hash']) }
