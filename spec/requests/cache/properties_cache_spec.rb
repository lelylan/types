...
feature 'Caching' do
  ...
  before { page.driver.header 'Content-property', 'application/json' }
  ...
  describe 'GET /properties/:id' do
    ...
    let(:cache_key) { ActiveSupport::Cache.expand_cache_key(['property_serializer', resource.cache_key, 'to-json']) }
      ...
      describe 'when sends the If-Modified-Since header' do
        ...
        describe 'when the resource changes' do
          ...
          it 'creates a new fragment cache' do
            new_key = ActiveSupport::Cache.expand_cache_key(['property_serializer', resource.cache_key, 'to-json'])
  ...
  describe 'GET /properties' do
    ...
    let(:cache_json_key) { ActiveSupport::Cache.expand_cache_key(['property_serializer', resource.cache_key, 'to-json']) }
    let(:cache_hash_key) { ActiveSupport::Cache.expand_cache_key(['property_serializer', resource.cache_key, 'serializable-hash']) }
